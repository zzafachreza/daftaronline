        ...
        <SafeAreaView style={{
            ...
            <View style={{
                ...
                <TouchableOpacity onPress={() => navigation.navigate('Account')} style={{
                    ...
                    <Icon type='ionicon' name='settings' size={windowWidth / 17} color={colors.secondary} />
                </TouchableOpacity>
            </View>
            <View style={{
                flex: 1,
            ...
            <View style={{
                ...
                <MyButton onPress={btnKeluar} warna={colors.secondary} title="Keluar" Icons="log-out" iconColor={colors.white} colorText={colors.white} />
            </View>
        </SafeAreaView>
    )
}
